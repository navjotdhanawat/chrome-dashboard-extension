      ...
      <div className=" shadow-lg">
        <div className="p-3 dark:bg-gray-800 bg-white rounded-lg">
          <div className="px-2 flex items-center justify-between">
            <span className="focus:outline-none  text-xs font-bold dark:text-gray-100 text-gray-800">
              October 2020
            </span>
                  ...
                  <td>
                    <div className="w-full h-full">
                      <div className="flex items-center justify-center w-full rounded-full cursor-pointer">
                        <a
                          role="link"
                          className="focus:outline-none  focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:bg-indigo-500 hover:bg-indigo-500 text-xs w-8 h-8 flex items-center justify-center font-medium text-white bg-indigo-700 rounded-full"
                        >
                          8
                        </a>
                      </div>
